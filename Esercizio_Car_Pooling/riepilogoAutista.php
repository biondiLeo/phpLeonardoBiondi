  ...
  <head>
    ...
    <body>
        <?php
          ...
          $scadenzaPatente = input($_POST["scadenzaPatente"]);
          $numeroPatente = input($_POST["numeroPatente"]);
        ...
        <div class="container" id="Contenitore">
          <div class="panel panel-default" id = "pannello">
            ...
            <div class="panel-body" id = "panelBody">
               <form id="form" class="form-horizontal" name="form" onsubmit="return validateForm()" action="esitoAutista.php" method = "post"> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6"><?php echo $numeroPatente; ?></div>
                </div>
                <hr>
                 <div class="form-group">
                  <label class="control-label col-md-4">Scadenza patente:</label>
                  <div class="col-md-6"><?php echo $scadenzaPatente; ?></div>
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="numeroPatenteHide" value=<?php echo $numeroPatente; ?> />
                  <input type="hidden" name="scadenzaPatenteHide" value=<?php echo $scadenzaPatente; ?> />
