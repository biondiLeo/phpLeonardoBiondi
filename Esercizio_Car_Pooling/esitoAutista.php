...
<html>
  ...
  <body>
    ...
    try
    {
       ...
       $query = $dbh->prepare("INSERT INTO autista(nomeAutista, cognomeAutista, dataNascita, password, userName, email, telefono, sesso, nazionalita, numeroPatente, scadenzaPatente) VALUES(:nome, :cognome, :dataNascita, :password, :userName, :email, :telefono, :sesso, :nazionalita, :numeroPatente, :scadenzaPatente)");
       ...
       $query->bindValue(":scadenzaPatente",$_POST['scadenzaPatenteHide']);
       $query->bindValue(":numeroPatente",$_POST['numeroPatenteHide']);
