...
<html>
  ...
  <body>
    ...
    try
    {
       ...
       $query = $dbh->prepare("INSERT INTO auto(marca, modello, cilindrata, potenza, targa, idAutista) VALUES(:marca, :modello, :cilindrata, :potenza, :targa, :idAutista)");
          ...
          <div class="panel panel-default" id = "pannello">
            <div class="panel-heading" id = "panelHeading"><h3 id="titolo">Esito registrazione</h3></div>
              <div class="panel-body" id = "panelBody">
                ...
                <hr>
                <div class="row">
                  <center><a href="dashboard.php" id="btnChiudi" name="bottoneRegistra" type="button">Chiudi</a></center>  
                </div>
              </div>
