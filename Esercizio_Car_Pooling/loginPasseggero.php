<?php
 ...
 if(isset($_SESSION['idPasseggero']))
  header('Location: dashboardPasseggero.php');
?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    ...
    if (isset($_POST['bottoneLogin']))
    {
      ...
      if($stm->rowCount() > 0)
      {
        ...
        echo "<h2> Connesso come " . $row['idPasseggero'] . "</h2>";
        echo '<a href="dashboardPasseggero.php"> Dashboard </a>';
      }
      else
      {
     ...
     <center>
        <div class="container" id="Contenitore">
          <div class="panel panel-default" id = "pannello">
            <div class="panel-heading" id = "panelHeading"><h3 id="titolo"><b>Login passeggero</b></h3></div>
